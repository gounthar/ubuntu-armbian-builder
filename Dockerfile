...
RUN apt-get update && apt-get -y install git corkscrew asciinema wget psmisc alsa-utils apt-transport-https aptitude \ 
 ...
 build-essential ca-certificates chromium chromium-browser command-not-found console-setup cpufrequtils crda cups cups-pk-helper \
 curl dbus-x11 device-tree-compiler dialog dirmngr dnsutils dosfstools eject ethtool evtest expect f2fs-tools f3 fake-hwclock \
 fbi fbset figlet flex fping galculator gcj-jre-headless gcr geany git gnome-keyring gnome-orca gnupg2 gtk2-engines \
 ...
 ntp numix-gtk-theme numix-icon-theme openssh-server p11-kit paman paprefs parted pasystray pavucontrol pavumeter pciutils \
 pluma policykit-1 policykit-1-gnome profile-sync-daemon psmisc pulseaudio pulseaudio-module-bluetooth pulseaudio-module-gconf \
 ...
 system-config-printer system-config-printer-common system-config-printer-gnome thunar-volman toilet u-boot-tools \
